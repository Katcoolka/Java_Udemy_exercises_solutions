package com.udemy.exercise51.immutable.class_;

import java.util.HashMap;
import java.util.Map;

//CORRECT CODE AS PER REQUIREMENTS IN THE DESCRIPTION BELOW
 ...
 * 
 * As an added Task, handle the case where exits is null when passed to the
 * constructor.
 * 
 * NOTE: Not all classes documented as "immutable" follow these rules. However,
 * the steps above are the basis of an Immutable Class.
 */
