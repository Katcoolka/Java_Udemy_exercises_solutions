package com.udemy.exercise20.greatest.common.divisor;

public class GreatestCommonDivisor {

	public static void main(String[] args) {
		System.out.println(
				"the greatest common divisor of the two numbers 25, 15 is: " + getGreatestCommonDivisor(25, 15));
		System.out.println(
				"the greatest common divisor of the two numbers 12, 30 is: " + getGreatestCommonDivisor(12, 30));
		System.out
				.println("the greatest common divisor of the two numbers 9, 18 is: " + getGreatestCommonDivisor(9, 18));
		System.out.println(
				"the greatest common divisor of the two numbers 81, 153 is: " + getGreatestCommonDivisor(81, 153));
