package com.udemy.exercise13.number.of.days.in.month;
...
public class NumberOfDaysInMonth {
	...
	public static int getDaysInMonth(int month, int year) {
		...
		switch (month) {
		case 2:
			return 28; //A return statement is a break statement, so you cannot have a return and a break in the same immediate block of code.
 ...
 * of type int.
 * 
 * If parameter month is < 1 or > 12 return -1. ​ If parameter year is < 1 or >
 * 9999 then return -1.
 * 
