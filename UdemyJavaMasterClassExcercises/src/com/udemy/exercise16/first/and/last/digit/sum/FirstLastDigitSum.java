package com.udemy.exercise16.first.and.last.digit.sum;

public class FirstLastDigitSum {

	public static void main(String[] args) {

		System.out.println("The sum of first and the last Digit of 252 is " + sumFirstAndLastDigit(252));
		System.out.println("The sum of first and the last Digit of 257 is " + sumFirstAndLastDigit(257));
		System.out.println("The sum of first and the last Digit of 0 is " + sumFirstAndLastDigit(0));
		System.out.println("The sum of first and the last Digit of 5 is " + sumFirstAndLastDigit(5));
		System.out.println("The sum of first and the last Digit of -10 is " + sumFirstAndLastDigit(-10));
	...
	public static int sumFirstAndLastDigit(int number) {
		...
		while (storedNumber > 9) {

			storedNumber = storedNumber /= 10;

		}
		return lastDigit + storedNumber;
	}
