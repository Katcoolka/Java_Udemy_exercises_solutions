package com.udemy.exercise23.number.to.words;

public class NumberToWords {

	public static void main(String[] args) {
		System.out.println("------------------number to words method----------------\n");
	...
	public static int getDigitCount(int number) {
		...
		/*
		 * for (int i = 0; number>0; i++) { number /=10; count++; }
		 */
 ...
 * is 0, "One" if the digit is 1, and so on. 3. Remove the last digit from the
 ...
 * return -1 to indicate an invalid value. For example, if the number has a
 * value of 100, the method getDigitCount should return 3 since the number 100
 * has 3 digits (1, 0, 0).
 * 
 ...
 * public static like we have been doing so far in the course. NOTE: In total,
 * you have to write 3 methods.
 * 
