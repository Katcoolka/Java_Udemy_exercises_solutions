package com.udemy.exercise47.interfaces;
 ...
 * strength). It initialises name, hitPoints and strength with the newly passed
 * in values. It initialises weapon with the default weapon "Sword".
 * 
 * - And eleven methods:
 * 
 * - Getters and setters for all four fields.
 * 
 * - write(), same as interface. Return a List of the fields in the order they
 * appear in toString().
 * 
 * - read(), same as interface. Store the values in the List, in the order they
 * appear in toString(). Make sure the List is not null and the size() is
 * greater than 0 before storing the values.
 * 
 ...
 * 3. Monster (class)
 * 
 * - It has three fields. One String called name and Two ints called hitPoints
 * and strength.
 * 
 * - A constructor that accepts a String (name) and two ints (hitPoints and
 * strength). It initialises name, hitPoints and strength with the newly passed
 ...
 * greater than 0 before storing the values.
 * 
 * - toString(), Monsters overriding toString() method. It takes no arguments
