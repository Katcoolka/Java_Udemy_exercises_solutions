package com.udemy.exercise22.perfect.number;

public class PerfectNumber {

	public static void main(String[] args) {
		System.out.println("is 6 the perfect number? " + isPerfectNumber(6));
		System.out.println("is 28 the perfect number? " + isPerfectNumber(28));
		System.out.println("is 5 the perfect number? " + isPerfectNumber(5));
		System.out.println("is -1 the perfect number? " + isPerfectNumber(-1));
...
/*
 * What is the perfect number? A perfect number is a positive integer which is
 * equal to the sum of its proper positive divisors. Proper positive divisors
 * are positive integers that fully divide the perfect number without leaving a
 * remainder and exclude the perfect number itself. For example, take the number
 * 6: Its proper divisors are 1, 2, and 3 (since 6 is the value of the perfect
