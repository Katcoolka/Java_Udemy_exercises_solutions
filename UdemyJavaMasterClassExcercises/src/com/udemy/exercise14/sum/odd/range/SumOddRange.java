package com.udemy.exercise14.sum.odd.range;

public class SumOddRange {

	public static void main(String[] args) {

		System.out.println(sumOdd(1, 17));
	...
	public static int sumOdd(int start, int end) {
		...
		for (int i = start; i <= end; i++) {
			if (isOdd(i)) {
				//System.out.println("Looping " + i); // adding this line you can test how many times it has to loop through
				sum += i;
			}
		}
		return sum;
